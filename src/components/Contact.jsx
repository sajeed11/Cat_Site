...
const Contact = () => {
	return (
		<div>
			<div className={`${styles.flexStart} bg-cat_landing2 bg-cover top-0 bottom-0 max-w-screen-xl`}>
				<div className={`${styles.boxWidth} `}>
					<section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} `}>
						<div
							className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}
						>
							<h1 className=" my-4 text-white font-poppins font-bold self-center text-5xl">About US</h1>
